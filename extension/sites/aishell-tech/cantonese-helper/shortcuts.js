(function () {
  if (globalThis.__ASREdgeAishellTechCantoneseShortcutsInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechCantoneseShortcutsInstalled = true;
  const ACTION_LABELS = {
    aiRecommendCurrentItem: "AI 识别当前条",
    autoFillQualifiedItem: "批量识别并保存",
    copyRecommendedText: "复制听音文本",
    fillRecommendedText: "原样填入当前条",
  ...
  globalThis.__ASREdgeAishellTechCantoneseShortcuts = {
    createRuntime,
  };
})();
