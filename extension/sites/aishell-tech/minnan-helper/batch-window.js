(function () {
  if (globalThis.__ASREdgeAishellTechMinnanBatchWindowInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechMinnanBatchWindowInstalled = true;
  ...
  globalThis.__ASREdgeAishellTechMinnanBatchWindow = api;
})();
