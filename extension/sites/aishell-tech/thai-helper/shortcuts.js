(function () {
  if (globalThis.__ASREdgeAishellTechThaiShortcutsInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechThaiShortcutsInstalled = true;
  const ACTION_LABELS = {
  ...
  globalThis.__ASREdgeAishellTechThaiShortcuts = {
    createRuntime,
  };
})();
