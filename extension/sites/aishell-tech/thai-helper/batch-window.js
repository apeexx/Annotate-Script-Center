(function () {
  if (globalThis.__ASREdgeAishellTechThaiBatchWindowInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechThaiBatchWindowInstalled = true;
  ...
  globalThis.__ASREdgeAishellTechThaiBatchWindow = api;
})();
