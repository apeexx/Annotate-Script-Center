(function () {
  if (globalThis.__ASREdgeAishellTechCantoneseDiagnosticsInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechCantoneseDiagnosticsInstalled = true;
  ...
  function formatModelSelection(models) {
    ...
    return normalizeText(source.omniModel) || "-";
  }

  function formatModeSummary(models) {
    const source = models && typeof models === "object" ? models : {};
    return normalizeText(source.pipelineMode) || "omni_single_raw_listen";
  }
