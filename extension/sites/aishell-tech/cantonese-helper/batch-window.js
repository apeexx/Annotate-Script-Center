(function () {
  if (globalThis.__ASREdgeAishellTechCantoneseBatchWindowInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechCantoneseBatchWindowInstalled = true;
...
globalThis.__ASREdgeAishellTechCantoneseBatchWindow = api;
})();
