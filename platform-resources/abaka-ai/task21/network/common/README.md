# Abaka AI / Task21 / common Network参考索引
## 目录定位

- 目录：`platform-resources/abaka-ai/task21/network/common`
- 类型：Network 稳定参考索引。
...
| 文件 | 说明 |
| --- | --- |
| `06-label-submit-success.md` | Task21 提交成功公共链路补充 |

## 阅读顺序

- 先读本索引，再按文件名顺序下钻到对应单页参考。
1. `06-label-submit-success.md`
